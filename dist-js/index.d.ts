 ...
 * @since 0.1.0
 */
export declare function onPowerSourceChanged(handler: (state: PowerState) => void): Promise<UnlistenFn>;
/**
 ...
 * @since 0.1.0
 */
export declare function onBatteryChanged(handler: (state: PowerState) => void): Promise<UnlistenFn>;
/**
 ...
 * @since 0.1.0
 */
export declare function onSuspend(handler: () => void): Promise<UnlistenFn>;
/**
 ...
 * @since 0.1.0
 */
export declare function onResume(handler: () => void): Promise<UnlistenFn>;
